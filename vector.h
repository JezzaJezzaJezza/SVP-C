...
double innerP(vector v, vector u, int dim);  // calculate the inner product of v and u -NOTE- inner product is equal to the norm squared, when using vectors where v = u